...
using BotTranslator.Connected_Services.MicrosoftTranslator;
using BotTranslator.Entity;

namespace BotTranslator.Services
{
    public class CognitiveServicesTranslator : ICognitiveServicesTranslator
    {
